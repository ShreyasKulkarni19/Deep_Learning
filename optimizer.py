...
new_model =load_model('pro_my_dl.h5')
...
save_pb_dir = './model'
model_fname = 'pro_dl_u.h5'
def freeze_graph(graph, session, output, save_pb_dir='.', save_pb_name='pro_dl_frozen_model_u.pb', save_pb_as_text=False):
...
pb_file = './model/pro_dl_frozen_model_u.pb'
output_dir = './model'
img_height = 128
